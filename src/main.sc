...
theme: /
    ...
    state: Start || sessionResult = "Сценарий начинается отсюда", sessionResultColor = "#143AD1"
        ...
        a: Добрый день! Я виртуальный секретарь Компании. Могу уточнить статус вашего заказа или рассказать о времени работы офиса. в2 || htmlEnabled = true, html = "Добрый день! Я виртуальный секретарь <b>Компании</b>. Могу уточнить статус вашего заказа или рассказать о времени работы офиса. в2"
        buttons:
